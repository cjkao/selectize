    ...
    _select = selectize(
        ...
        new SelectOptions(
            ...
            onChange: allowInterop((List value) {
              ...
              zone.run(() => this.selectedValue = value.join(','));
            }),
            maxItems: 3,
            valueField: "email",
            sortField: "email",
...
//  var jj = new JsObject.fromBrowserObject(jquery('#select-box').selectize())[0];
//  Selectize tt = util.getProperty(jj, 'selectize');
  //tt.clear();
//  tt.addItem('big');
//  tt.createItem('a', true);
  var iTag = selectize('#select-box');
  iTag.createItem('z', true);
//  iTag.addOption(ue('a', 'b'));
//  print(iTag.options);
